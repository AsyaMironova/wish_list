...
Идея заключается в том, что в нем пользователи могут добавлять свои хотелки и делиться ими с друзьями, пользователи могут видеть какие подарки уже куплены, а какие нет, ссылки на покупки этих подарков так же должны прикрепляться.
